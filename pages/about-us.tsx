...
export default function AboutVaultinum() {
    ...
    return (
        <>
            <Head
                title="Vaultinum — About us"
                description="Vaultinum brings the modern web to intellectual property."
            />

            <Container>
                <section className="about-us-intro container block">
                    <Heading>{t.aboutUs.aboutUs}</Heading>
                    <div className="grid grid-1x2">
                        <div>
                            <p>
                                Vaultinum (formerly CELOG) is a trusted, independent, and neutral third party
                                specialized in digital asset protection.
                            </p>

                            <p>
                                The dematerialization of information and exchanges has contributed to the significant
                                increase in digital disputes. It has created new challenges with increased risk of data
                                loss, theft , and misuse.
                            </p>

                            <p>
                                Our mission is to protect our clients’ most important assests and to ensure their
                                business continuity.
                            </p>

                            <p>
                                Through an unrivalled range of services, Vaultinum solves issues related to the
                                collection and analysis of evidence in a digital environment.
                            </p>
                        </div>
                        <iframe
                            width="560"
                ...
                <section className="container block">
                    ...
                    <p className="text-center">
                        Vaultinum experts are committed to protecting the intellectual property of creators.
                    </p>
                    <p className="text-center">
                        Thanks to its legal and technical competencies, our team is able to assist our clients in their
                        cases and offer them reliable and effective probative solutions in accordance with state of the
                        art, in line with their needs.
                    </p>
                </section>
